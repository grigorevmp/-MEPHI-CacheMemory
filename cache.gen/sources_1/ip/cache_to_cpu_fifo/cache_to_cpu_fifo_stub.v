...
// Command     : write_verilog -force -mode synth_stub -rename_top cache_to_cpu_fifo -prefix
//               cache_to_cpu_fifo_ cache_to_cpu_fifo_stub.v
...
module cache_to_cpu_fifo(wr_clk, wr_rst, rd_clk, rd_rst, din, wr_en, rd_en, 
  dout, full, empty)
