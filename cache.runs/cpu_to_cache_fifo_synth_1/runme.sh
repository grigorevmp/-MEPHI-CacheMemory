...
HD_PWD='D:/Coding/Vivado/cache/cache.runs/cpu_to_cache_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_to_cache_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_to_cache_fifo.tcl
